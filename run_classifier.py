...
from BertCapsule import BertForSequenceCapsuleClassification_meta,BertForSequenceCapsuleClassification
...
class BCapsProcessor(DataProcessor):
    """For BCapsule data set"""
